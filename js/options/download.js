...
function save_type() {
  ...
  if (this.checked)
    ...
    chrome.runtime.sendMessage(chrome.runtime.id, { id: DOWNLOAD.REQUEST.URL_SET_TYPE, data: type });
}
...
function save_url_enabled() {
  ...
  chrome.runtime.sendMessage(chrome.runtime.id, { id: DOWNLOAD.REQUEST.URL_SET_ENABLED, data: this.checked });
}
...
function send_urls_add(data) {
  chrome.runtime.sendMessage(chrome.runtime.id, { id: DOWNLOAD.REQUEST.URL_ADD_URLS, data: data }, show_url);
}

function send_urls_remove(data) {
  chrome.runtime.sendMessage(chrome.runtime.id, { id: DOWNLOAD.REQUEST.URL_REMOVE_URLS, data: data }, show_url);
}
